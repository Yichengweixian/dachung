...
生成脚本：`scripts/check_materials_numbers.py`；出处表：`docs/number_sources.csv`；共 72 行；判定：**consistency_passed**。
...
- N35：1480 次 ← `results/ga/U12R01-v01/summary.csv` 选择器 `seed=42` 列 `evaluations`
- N44：4.2105180453333446e-11 - ← `results/prototype/U13R01-v01/checks.json` 选择器 `key=rule_24h_max_diff` 列 ``
- N38：0.0800103 % ← `results/ga/U12R01-v01/summary.csv` 选择器 `seed=42` 列 `relative_error`
