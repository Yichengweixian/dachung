"""Verify a stopped U11R04 run without resuming or re-solving it."""
import argparse
import json
...
from run_energy_calibrated_days import baseline_guard, CHANNELS
from run_budgeted_ga import saved_cost
from src.annual_clustering import annual_metrics
from src.energy_calibrated_weights import check_stage
